...
public class TeleOP_Blue extends OpMode
{
    ...
    public void loop(){
        ...
        intakeClaw.IntakeUpdate(gamepad1,leftWristDown,leftWristUp,rightWristDown,rightWristUp,hoverOverRight,hoverOverLeft,closedClaw,openClaw,defaultWrist,true, outtakeClaw.returnForceIntake(),pickedUpLeft,pickedUpRight);
