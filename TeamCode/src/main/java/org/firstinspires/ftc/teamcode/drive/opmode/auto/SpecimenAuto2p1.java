...
@Config
@Autonomous(name="Specimen2p1")
public class SpecimenAuto2p1 extends LinearOpMode {
    ...
    public void runOpMode()
    {
        ...
        Action comePickup = drive.actionBuilder(closeupPose)
                .splineToConstantHeading(new Vector2d(-59, -50), Math.PI)
                .build();
        Action comePickup1 = drive.actionBuilder(new Pose2d(-40,-58,0))
                .splineToConstantHeading(new Vector2d(-61, -58), Math.PI)
                .build();
        /*
        ############################################
        ...
        */
        Action moveToPrePlace = drive.actionBuilder(gotSpecimenInRobot)
                ...
                .build();
        Action moveToPrePlace1 = drive.actionBuilder(new Pose2d(-55,-58,Math.PI))
                .splineToConstantHeading(new Vector2d(0, 53), -Math.PI)
                .build();
        Pose2d placedPiec1 = new Pose2d(-24,-5, Math.PI);
